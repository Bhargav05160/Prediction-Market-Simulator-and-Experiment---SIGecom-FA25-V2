...
function Terms_PopUp({ isOpen, onClose, children, closeButton_name }) {
    ...
    <div style={styles.overlay} >
      <div style={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ textAlign: 'center', marginTop: '16px' }}>
          <button
            style={{ border: '1px solid #000000', borderRadius: '4px', padding: '8px 16px', backgroundColor: btnHovered ? '#e0e0e0' : 'transparent' }}
            onClick={onClose}
